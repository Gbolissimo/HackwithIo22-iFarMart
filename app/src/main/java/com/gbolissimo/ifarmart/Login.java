...
//                Intent signup = new Intent(Login.this,SignUpActivity.class);
                Intent signup = new Intent(Login.this,AddActivity.class);
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
              ...
              //      putPref("Cover", "", getApplicationContext());
               //     putPref("Title", "", getApplicationContext());
                    ...
                    Toast.makeText(Login.this,"Error! Please check your email, password or internet connection.", Toast.LENGTH_LONG).show();
                    mProgress.cancel();
                }
